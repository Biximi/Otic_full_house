...
import styles from "./OticSuiteResultsEntryForm.module.css";
const OticSuiteResultsEntryForm: FunctionComponent = () => {
  return (
    <div className={styles.oticSuiteResultsEntryForm}>
      <Header
...
export default OticSuiteResultsEntryForm;
