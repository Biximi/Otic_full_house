...
import styles from "./OticSuiteStudentsForm.module.css";
const OticSuiteStudentsForm: FunctionComponent = () => {
  return (
    <div className={styles.oticSuiteStudentsForm}>
      <Header
...
export default OticSuiteStudentsForm;
